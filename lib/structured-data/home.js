const homeStructuredData = {
  ...
  review: [
    ...
    },
    {
      ...
      reviewBody:
        "Звернувся з гострим болем — прийняли в той же день. Вразила швидкість і професіоналізм лікаря. Сучасне обладнання та приємний персонал.",
      reviewRating: {
        "@type": "Rating",
        ratingValue: "5",
        bestRating: "5",
