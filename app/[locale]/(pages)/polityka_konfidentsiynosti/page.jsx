  ...
  return (
    <>
      <article className="container-padding py-5 mt-[5rem]">
        ...
        <p>
          1.1.1. «Адміністрація Сайту (далі – Адміністрація Сайту)» –
          уповноважені співробітники на управління Сайтом, що діють від імені
          веб-сайту «Status», які організовують і здійснюють обробку
        ...
        <p>
          1.1.2. «Персональні дані» – будь-яка інформація, що стосується прямо
          або побічно певного або визначається фізичній особі (суб’єкту
          персональних даних).
        </p>
        <p>
        ...
        <p>
          1.1.4. «Конфіденційність персональних даних» – обмежена в доступі для
          всіх юридичних чи фізичних осіб, крім Адміністраторів або інших
          співробітників клініки. Така інформація може поширюватися за бажанням
        ...
        <p>
          1.1.5. «Користувач Сайту Status» – особа, яка має доступ до Сайту, за
          допомогою мережі Інтернет і використовує Сайт.
        </p>
        <p>
        ...
        <p>
          ...
          «Status». Веб-сайт не контролює та не несе відповідальність за Сайти
          третіх осіб, на які Користувач може перейти за посиланнями, доступними
          на Сайті.
        </p>
        <p>
        ...
        <p>
          ...
          реєстраційної форми на Сайті «Status» в розділі про реєстрацію та
        ...
        <p>
          ...
          оформлення послуги дистанційним способом з веб-сайту «Status».
        </p>
        <p>
