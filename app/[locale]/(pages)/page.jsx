    ...
    <>
      <div className="flex flex-col w-full h-full">
        ...
        <aside className="hidden sm:flex flex-col w-[4rem] h-full fixed top-0 right-0">
          <div className="flex flex-[60.7%] flex-col justify-center items-center bg-[#ccdde4]">
          ...
          <div className="flex flex-[39.3%] justify-center items-center">
        ...
        <div className="flex flex-col xl:flex-row h-auto xl:h-[49.5rem] w-full justify-end px-[2rem] sm:px-[4rem]">
          <div className="flex h-full w-full xl:w-[45%] flex-col ">
            <div className="flex w-full h-[5.5rem] bg-[#fff]"></div>
            <div className="flex relative flex-col w-full h-full justify-start items-start">
              <h1 className="w-full sm:w-[26rem] absolute top-0 sm:top-10 left-5 text-center sm:text-left text-[2.5rem] sm:text-[4rem] font-bold pr-[2.5rem] sm:pr-0">
                Treat yourself with beautiful,{" "}
                <span className="text-[#5ba3bb]">white</span> smile.
              </h1>
              ...
              <div className="flex w-full h-auto justify-between items-center px-[1rem] sm:px-[4rem]">
                <ShortServicesList />
              </div>
          ...
          <div className="flex relative w-full xl:w-[55%] flex-col h-full">
            <div className="hidden xl:flex w-full h-[5.5rem] bg-[#ccdde4]" />
        ...
        <div className="flex flex-col sm:flex-row items-center relative w-full h-auto sm:h-[47.5rem] my-[2rem] lg:my-[4rem] xl:my-[8rem] px-[2rem] sm:px-[4rem]">
          ...
          <div className="flex flex-col justify-center items-center w-full sm:w-[40%] order-1 sm:order-2">
            ...
            <p className="text-[#A7ADAF] my-[3rem]">
              ...
              oral cancer screenings. Our new patient information page provides
              helpful information about what to expect during your first visit
            ...
            <div className="hidden sm:flex lg:flex-row sm:flex-col w-full h-auto items-center p-2">
              ...
              <Link
                href="#"
                className="font-semibold text-[#5ba3bb] text-nowrap underline underline-offset-8 decoration-4 ml-0 lg:ml-5"
              >
                LEARN MORE
              </Link>
            </div>
        ...
        <div className="flex flex-col lg:flex-row w-full h-auto items-center p-[2rem] sm:p-[6rem]">
          ...
          <div className="flex flex-col justify-center items-center w-full sm:w-[65%] lg:pl-[4rem] xl:pl-[8rem] order-1 lg:order-2">
            ...
            <p className="text-[#A7ADAF] my-[3rem]">
              Dr. Giovanni is prominent dental specialist, who knows how to
              treat every problem. 10+ years of experience translates into
              bespoke treatment of every pacient.
            </p>
        ...
        <div className="hidden sm:flex w-full h-auto px-[6rem] mb-[6rem]">
          <div className="flex items-end w-[50%] h-full pt-[8rem]">
          ...
          <div className="flex relative flex-col items-end w-[50%] h-full">
            ...
            <div className="flex relative w-full h-full items-center">
              ...
              <p className="font-secondary italic text-[1.5rem] md:text-[1.5rem] xl:text-[2rem] text-[#5ba3bb]">
        ...
        <div className="flex sm:hidden flex-col w-full h-auto mb-[4rem] px-[2rem]">
          <div className="flex items-end w-full h-full">
            ...
            <div className="flex relative w-full h-full items-center pr-5">
              ...
              <p className="font-secondary italic text-[1rem] text-[#5ba3bb]">
                Dr. Giovanni is a genius! Treatment went well and now my smile
                shines! Thank YOU!
              </p>
            </div>
        ...
        <div>
          <div className="flex w-full h-[10rem] bg-red-200"></div>
        </div>
      </div>
    </>
  );
